...
from ohqa.workspace import get_sessions_dir


def get_session_dir(workspace: str | Path | None = None) -> Path:
    """Return the ohqa sessions directory."""
...
def save_session_snapshot(
    *,
    ...
    """Persist the latest ohqa session snapshot."""
    session_dir = get_session_dir(workspace)
...
class OhqaSessionBackend(SessionBackend):
    """Session backend rooted in ``.ohqa/sessions``."""
